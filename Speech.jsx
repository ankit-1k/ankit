      ...
      <main className={`main-container`}>
          ...
          <div className="wrap-slilset">
            <div>
              ...
              <dl className='skill-list'>
                ...
                <div className="form-check form-switch">
                  <input className="form-check-input" type="checkbox" id="boot" onChange={FireBoot} checked={boot} />
                  <label className="form-check-label" htmlFor="boot">Bootstrap</label>
                </div>
                <div className="form-check form-switch">
                  <input className="form-check-input" type="checkbox" id="js" onChange={FireJS} checked={JS} />
        ...
        <section className="about">
          ...
          <div className="sec-about">
            <div className="card card-about">
              <p data-aos="fade-up"
                data-aos-anchor-placement="top-center">
                "As a skilled programmer, I possess expertise in building responsive web designs using HTML, CSS, and JavaScript. Proficient in frameworks such as Bootstrap and React, I also have a fundamental understanding of Angular. Currently, I am engaged in freelancing activities, specializing in the development of static websites for various clients. My focus lies in creating visually appealing and user-friendly interfaces, ensuring a seamless and engaging user experience. With a strong foundation in web development technologies, I continuously strive to implement the latest industry trends and best practices in my projects, aiming to deliver high-quality and efficient solutions tailored to meet client requirements."            </p>
            </div>
          </div>
        </section>
        <section className="resume mt-5">
          ...
          <div className="sec-resume">
            <div className="card hello" style={{ width: '20rem' }} data-aos="fade-up"
              data-aos-anchor-placement="top-center">
            ...
            {/* certification */}
            <div className="card" style={{ width: '20rem' }} data-aos="fade-up"
              data-aos-anchor-placement="top-center">
              <div className={`card-body`}>
          ...
          <div className="wrap-footer">
              ...
              <div className="card">
                <div className="body">
                  <div className="card-title text-center">
                    <svg className='shake-icon' xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 0 512 512"><path d="M64 112c-8.8 0-16 7.2-16 16v22.1L220.5 291.7c20.7 17 50.4 17 71.1 0L464 150.1V128c0-8.8-7.2-16-16-16H64zM48 212.2V384c0 8.8 7.2 16 16 16H448c8.8 0 16-7.2 16-16V212.2L322 328.8c-38.4 31.5-93.7 31.5-132 0L48 212.2zM0 128C0 92.7 28.7 64 64 64H448c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128z" /></svg>
                  </div>
                </div>
              </div>
            </div>
            <div className="phone" onClick={FirePhone}>
              <div className="card">
                <div className="body">
                  <div className="card-title text-center">
                    <svg className="shake-icon" xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 0 512 512"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg>
                  </div>
                </div>
              </div>
            </div>
            <div className="profile">
              <div className="card">
                <div className="body">
                  <div className="card-title text-center">
                    <svg className='shake-icon' xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 0 448 512"><path d="M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464H398.7c-8.9-63.3-63.3-112-129-112H178.3c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3z" /></svg>
                  </div>
                </div>
              </div>
            </div>
            <div className="location">
              <div className="card">
                <div className="body">
                  <div className="card-title text-center">
                    <svg className='shake-icon' xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 0 448 512"><path d="M429.6 92.1c4.9-11.9 2.1-25.6-7-34.7s-22.8-11.9-34.7-7l-352 144c-14.2 5.8-22.2 20.8-19.3 35.8s16.1 25.8 31.4 25.8H224V432c0 15.3 10.8 28.4 25.8 31.4s30-5.1 35.8-19.3l144-352z" /></svg>
                  </div>
                </div>
              </div>
            </div>
